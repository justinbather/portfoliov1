...
const AboutMe = () => {
  ...
  return (
    <div className="md:flex md:flex-row w-screen justify-evenly h-screen ">
      <div className="flex flex-col md:w-1/2 justify-center pl-20 h-full " id="title">
      ...
      <div className="flex flex-col w-1/2 gap-10 px-10 h-full overflow-y-scroll">
        <div className="pt-[55%] pb-40" id="about">
          <div className="text-center text-[#6e6e73] bg-[#fff] w-full py-5 px-5 rounded-xl drop-shadow-md bg-white bg-opacity-70 backdrop-blur-lg align-middle" >
            <h3 className="font-inter text-lg" >Hey there! I'm a Software Engineer II at Apex Fintech Solutions in Belfast.</h3>
